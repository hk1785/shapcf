...
### 3. Example Datasets
* :mag: **`ecigarette`**: Subgingival microbiome data on e-cigarette use and gingival inflammation.
* :mag: **`antibiotic`**: Gut microbiome data on antibiotic treatment and type 1 diabetes.
* :mag: **`immuno`**: Gut microbiome data on cancer immunotherapy response in melanoma patients.
